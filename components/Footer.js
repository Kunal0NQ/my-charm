...
<footer class="text-gray-600 body-font">
    ...
    <div class="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
      <div class="lg:w-1/4 md:w-1/2 w-full px-4">
        ...
        <nav class="list-none mb-10">
          <li>
            <Link href='/' class="text-gray-600 hover:text-gray-800">First Link</Link>
          </li>
          <li>
            <Link href='/' class="text-gray-600 hover:text-gray-800">Second Link</Link>
          </li>
          <li>
            <Link href='/' class="text-gray-600 hover:text-gray-800">Third Link</Link>
          </li>
          <li>
            <Link href='/' class="text-gray-600 hover:text-gray-800">Fourth Link</Link>
          </li>
        </nav>
      </div>
      <div class="lg:w-1/4 md:w-1/2 w-full px-4">
  ...
  <div class="bg-gray-100">
    <div class="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
      <p class="text-gray-500 text-sm text-center sm:text-left">© 2024 PKGS —
